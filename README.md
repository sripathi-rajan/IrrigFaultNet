...
2. Paste `diagram.json` and `sketch.ino`
3. Hit ▶ — Serial Monitor opens automatically
4. Twist potentiometers to simulate different moisture conditions

### Google Colab (ML Pipeline)
1. Open `DesignThinking.ipynb` in Google Colab
2. Run all cells in order
3. Outputs: FIHS score, fault classification, dashboard PNG, CSV exports
